...
Object.assign(globalThis, {
    ...
    _project_: 'MatiX',
    _project_SM_: 'matix',
    _repo_: atob('aHR0cHM6Ly9naXRodWIuY29tL3NjaG9vbGRhcnM5MS1tYWtlci9NYXRpeHBhbmVs'),
    _wizard_repo_: atob('aHR0cHM6Ly9naXRodWIuY29tL3NjaG9vbGRhcnM5MS1tYWtlci9NYXRpeHBhbmVsL3RyZWUvbWFpbi93aXphcmQ='),
    _website_: atob('aHR0cHM6Ly9naXRodWIuY29tL3NjaG9vbGRhcnM5MS1tYWtlci9NYXRpeHBhbmVs'),
...
export function init(request: Request, env: Env) {
    if(env.UUID || env.TR_PASS || typeof EMBEDED_SETTINGS === 'undefined') {
        throw new Error(`MatiX Panel v5 can only be installed using <a href="${_wizard_repo_}/secrets" target="_blank">BPB Wizard v3</a> or later.`);
    }
